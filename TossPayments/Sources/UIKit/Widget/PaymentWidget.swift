...
public final class PaymentWidget: NSObject, HandleURLResult {
    ...
    public weak var paymentMethodsWidgetUIDelegate: TossPaymentsWidgetUIDelegate?
    ...
    public func renderPaymentMethods(amount: PaymentMethodWidget.Amount, options: PaymentMethodWidget.Options? = nil) -> PaymentMethodWidget {
        ...
        paymentMethodWidget.widgetStatusDelegate = widgetStatusDelegate
        paymentMethodWidget.widgetUIDelegate = paymentMethodsWidgetUIDelegate
    ...
    public func renderAgreement() -> AgreementWidget {
        ...
        agreementWidget.widgetStatusDelegate = widgetStatusDelegate
